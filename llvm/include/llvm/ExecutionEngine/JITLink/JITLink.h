...
// First argument refers to a WriteableMemoryBuffer
...
public:
  ...
  LinkGraph(std::string Name, const Triple &TT, unsigned PointerSize,
      ...
      : Name(std::move(Name)), TT(TT), PointerSize(PointerSize),
        Endianness(Endianness), PrepareDebugObjFunc(std::move(PrepareDebugObjFunc)) {}
...
public:
  ...
  virtual Error notifyResolved(LinkGraph &G, const SegmentLayoutMap &Layout) = 0;
  ...
  //virtual sys::MemoryBlock getObjBufferBlock() { return sys::MemoryBlock(); }
