...
static void outsv(const char *Fmt, Ts &&... Vals) {
...
LLIBuiltinFunctionGenerator::LLIBuiltinFunctionGenerator(
    std::vector<BuiltinFunctionKind> Enabled,
    orc::MangleAndInterner &Mangle) : TestOut(nullptr) {
  Generator = this;
...
Error LLIBuiltinFunctionGenerator::tryToGenerate(
                    orc::LookupState &LS, orc::LookupKind K,
