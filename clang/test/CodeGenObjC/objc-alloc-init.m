...
// RUN: %clang_cc1 %s -fobjc-exceptions -fexceptions -triple x86_64-pc-windows-msvc -fobjc-runtime=gnustep-2.0 -emit-llvm -O0 -o - | FileCheck %s --check-prefix=NOT_OPTIMIZED --check-prefix=EITHER
